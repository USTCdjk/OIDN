...
from .complexFunctions import complex_dropout, complex_dropout2d, complex_opposite
...
class ComplexConv2d(Module):
    ...
    def __init__(self,in_channels, out_channels, kernel_size=3, stride=1):
        ...
        self.conv_r = Conv2d(in_channels, out_channels, kernel_size, stride, padding=(kernel_size // 2), dilation=1, groups=1, bias=True)
        self.conv_i = Conv2d(in_channels, out_channels, kernel_size, stride, padding=(kernel_size // 2), dilation=1, groups=1, bias=True)
